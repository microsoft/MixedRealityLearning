...
namespace Leap.Unity {
  ...
  public class HandPool : MonoBehaviour {
    ...
    private Transform _modelsParent = null;
    /// <summary>
    ...
    [SerializeField]
    private List<ModelGroup> ModelPool = null;
    ...
    */
    ...
    private bool shouldBeSpawned(UnityEngine.Object model) {
      if (!InternalUtility.IsPrefab(this)) {
        return InternalUtility.IsPrefab(model);
      } else {
        return InternalUtility.IsPrefab(model) != InternalUtility.IsPrefab(this);
      }
    }
