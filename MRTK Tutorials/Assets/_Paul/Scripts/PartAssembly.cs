...
public class PartAssembly : MonoBehaviour
{
    ...
    private Vector3 originalObjectPlacementScale;
    ...
    void Start()
    {
        ...
        originalObjectPlacementScale = objectToPlace.localScale;
    ...
    public void ResetPlacement()
    {
        ...
        objectToPlace.localScale = originalObjectPlacementScale;
