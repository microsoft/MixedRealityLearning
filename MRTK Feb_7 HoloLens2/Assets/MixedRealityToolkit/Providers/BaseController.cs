...
namespace Microsoft.MixedReality.Toolkit.Core.Providers
{
    ...
    public abstract class BaseController : IMixedRealityController
    {
        ...
        private void TryRenderControllerModel(Type controllerType, InputSourceType inputSourceType)
        {
            ...
            if (controllerModel == null)
            {
                ...
                {
                    if (inputSourceType == InputSourceType.Controller && MixedRealityToolkit.Instance.ActiveProfile.InputSystemProfile.ControllerVisualizationProfile.GlobalLeftHandModel != null)
                    {
                    ...
                    else if (inputSourceType == InputSourceType.Hand && MixedRealityToolkit.Instance.ActiveProfile.InputSystemProfile.ControllerVisualizationProfile.GlobalLeftHandVisualizer != null)
                    {
                        controllerModel = MixedRealityToolkit.Instance.ActiveProfile.InputSystemProfile.ControllerVisualizationProfile.GlobalLeftHandVisualizer;
                    }
                }
                else if (ControllerHandedness == Handedness.Right)
                {
                    if (inputSourceType == InputSourceType.Controller && MixedRealityToolkit.Instance.ActiveProfile.InputSystemProfile.ControllerVisualizationProfile.GlobalRightHandModel != null)
                    {
                    ...
                    else if (inputSourceType == InputSourceType.Hand && MixedRealityToolkit.Instance.ActiveProfile.InputSystemProfile.ControllerVisualizationProfile.GlobalRightHandVisualizer != null)
                    {
                        controllerModel = MixedRealityToolkit.Instance.ActiveProfile.InputSystemProfile.ControllerVisualizationProfile.GlobalRightHandVisualizer;
                    }
                }
            }
